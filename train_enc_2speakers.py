...
import params
from data_cycle_2speakers import VCTKEncDataset, VCEncBatchCollate
...
data_dir = '/home/rtrt505/speechst1/DiffVC/VCTK_2speakers'
val_file = 'filelists/valid.txt'
exc_file = 'filelists/exceptions_vctk.txt'
avg_type = 'mode'

use_gpu = torch.cuda.is_available()
log_dir = 'logs_enc_2speakers'
epochs = 500
batch_size = 128
learning_rate = 5e-4
save_every = 20
...
if __name__ == "__main__":
    ...
    vc_path = f'/home/rtrt505/speechst1/DiffVC/logs_enc_2speakers/enc.pt' # path to voice conversion model
